      ...
      <div className="lg:h-full lg:align-middle lg:items-center dark:bg-transparent">
        {Object.keys(entries).map(eType => {
          ...
          return <div key={eType}>
            <div className="p-2 m-2 dark:bg-neutral-900/75 rounded-lg w-fit">
            ...
            <div className="align-middle md:flex flex-wrap justify-start">
              {Object.keys(entryCategory.entries).map(key => {
                ...
                return <Card onClick={() => {
                  ...
                  setEntryKey(key);
                  setOpenModal(true);
                  }} key={key} imgAlt={entry.title} imgSrc={entry.image} className="w-72 m-2 max-w-full dark:bg-neutral-900/75 dark:border-none">
